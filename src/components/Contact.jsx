            ...
            <div classNameName="w-full draggable">
                <div className="container flex flex-col items-center gap-16 mx-auto my-32">
                    <div className="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <p className="text-base leading-7 text-dark-grey-600">Reach out to me by phone</p>
                        <a className="text-lg font-bold text-purple-blue-500" href="tel:+91-6370411295">+91-6370411295</a>
                        </div>
                        <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38" fill="none">
                        ...
                        <a className="text-lg font-bold text-purple-blue-500" target="_blank" href="https://maps.app.goo.gl/sibPztQGBgRyZeCZ6">Bhubaneswar,India</a>
                        </div>
                    </div>
                </div>
            </div>
